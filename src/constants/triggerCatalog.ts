...
export const TRIGGER_CATALOG: TriggerDefinition[] = [
    // --- FINANCE TRIGGERS ---
    {
        ...
        description: 'Triggered when a transaction is successfully settled (Gateway or Manual).',
        category: 'FINANCE',
        iconName: 'CreditCard',
        variables: [
    ...
    },
    {
        ...
        description: 'Triggered when Finance settles a commission payment to a facilitator.',
        category: 'FINANCE',
        iconName: 'DollarSign',
        variables: [
    ...
    },
    {
        ...
        iconName: 'Gift',
        variables: [
            { key: 'age', label: 'Turning Age', example: '30' }
        ]
    },
    ...
    },
    {
        ...
        variables: [
            { key: 'delivery_date', label: 'Date', example: '2025-03-12' }
        ]
    },
