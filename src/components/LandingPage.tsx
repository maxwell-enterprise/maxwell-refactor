  ...
  useEffect(() => {
    ...
    if (authError) {
      const messages: Record<string, string> = {
        ...
        google_auth_failed:
          'Google sign-in failed. Try again or use email link.',
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex justify-between items-center h-20'>
            ...
            <div className='flex flex-col items-start cursor-pointer'>
              ...
              />
              <span className='text-[9px] uppercase tracking-[0.35em] text-blue-700 font-bold mt-1 ml-0.5'>
                Indonesia
              </span>
            </div>
        ...
        >
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-8'>
              <span className='text-indigo-600 font-bold tracking-wider uppercase text-xs'>
                Limited Time Only
              </span>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              {featuredOffers.map((offer) => (
                <div
                  key={offer.id}
                  className='bg-white rounded-xl p-6 shadow-md border-2 border-indigo-100 flex flex-col relative overflow-hidden group hover:-translate-y-1 transition-transform'
                >
      ...
      <section id='programs' className='py-16 bg-white'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex flex-col md:flex-row justify-between items-end mb-12'>
            ...
            <a
              href='#'
              className='hidden md:flex items-center text-blue-600 font-medium hover:underline mt-4 md:mt-0'
            >
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-6'>
            {PUBLIC_STORE.map((item, idx) => (
              <div
                key={idx}
                className='bg-white rounded-xl p-4 shadow-sm hover:shadow-lg transition-all group'
              >
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8'>
          <div className='col-span-1 md:col-span-2'>
            <span className='text-2xl font-bold text-white mb-4 block'>
              Maxwell<span className='font-light'>Leadership</span>
            </span>
            <p className='max-w-sm mb-6'>
              Empowering men and women to lead with purpose and integrity in
