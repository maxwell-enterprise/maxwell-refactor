...
import { CheckCircle, Gift, RefreshCw } from 'lucide-react';
...
/** Shared header bell so the workspace layout and the My Zone phone shell stay in sync. */
